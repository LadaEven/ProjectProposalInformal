...
\begin{document}
    ...
    \begin{abstract}
        ...
        connections. These are connections which have simple poles only.
...
%        факторы.
    ...
    %     Локальносвободный пучок конечного ранга на многообразии
        ...
        % И вроде бы первая часть у нас более-менее случилась, что уже, конечно, весьма немало, а до второй мы как-то пока не дошли. 
